...
import io.github.jesterz91.room.uitl.SingletonHolder
...
abstract class WordDatabase : RoomDatabase() {
    ...
    companion object : SingletonHolder<WordDatabase, Context>(
        creator = { context ->
            Room.databaseBuilder(context, WordDatabase::class.java, "word.db")
